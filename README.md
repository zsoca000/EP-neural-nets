...
You can run the entire workflow step-by-step using Python scripts. And you can evaluate the specific task with the numbered Jupyter notebooks in the `notebooks/` directory.
